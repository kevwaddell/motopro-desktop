...
?>
<div class="login<?php echo (function_exists('is_maintenance') && is_maintenance()) ? ' maintenance_active':''; ?>" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form name="loginform" id="loginform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'login' ); ?>" method="post">
		...
		<p class="submit login-btn">
			<input type="submit" name="wp-submit" id="wp-submit<?php $template->the_instance(); ?>" class="btn btn-default btn-block" value="<?php esc_attr_e( 'Log In' ); ?>" />
	...
	<a href="<?php echo get_option('home'); ?>/"><i class="fa fa-angle-double-left"></i> Go Back</a>
<?php } else { ?>
	<a href="<?php echo get_option('home'); ?>/">Return to website <i class="fa fa-angle-double-right"></i></a>
<?php } ?>
